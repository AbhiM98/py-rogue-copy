...
class RoguesS3PathKeys(StrEnum):
    """S3 Path Keys for Rogues data."""
...
class RoguesS3PathExamples(StrEnum):
...
class RoguesS3PathStructure:
    ...
    @staticmethod
    def from_s3_path_example(s3_path_example: str):
    ...
    def infer_structure_and_parse_s3_key(s3_key: str):
        ...
        for example in RoguesS3PathExamples:
            try:
...
if __name__ == "__main__":
    test = "2023-rgbd-data/Field 1 (Dennis Zuber)/2021-07-08/row-1/123456/bottom.mp4"
    print(RoguesS3PathStructure.infer_structure_and_parse_s3_key(test))
