"""Extract frames from each decasecond split in a row or field."""
...
def main():
    ...
    Example usage:
    python ./ground_data_processing/processing_entrypoints/extract_frames.py --field_name "Foundation Field 2 (Dennis Zuber)" --date "2022-05-19"
    """
    base_entrypoint(extract_frames_from_row, ProcessingSteps.EXTRACT_FRAMES)
